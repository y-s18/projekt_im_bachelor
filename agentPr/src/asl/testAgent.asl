...
/* NE------>N */
//1 block
+!checkObstacles(ne,n): obstacle(-1,-1) & not obstacle(0,-1) & not obstacle(1,-1) & extraAction(false) & (lastAction(no_action) | lastAction(move) | lastAction(skip) | lastAction(submit) | lastAction(attach)) & lastActionResult(success) <- -+currDir(e); -+extraAction(true); -+extraActionValues(mo,n); !chooseAction(mo,e);.//ne when nw should e XXXX
...
+!checkObstacles(ne,n): not obstacle(-1,-1) & not obstacle(0,-1) & obstacle(1,-1) & extraAction(false) & (lastAction(no_action) | lastAction(move) | lastAction(skip) | lastAction(submit) | lastAction(attach)) & lastActionResult(success) <- -+currDir(e); -+extraAction(true); -+extraActionValues(mo,s); !chooseAction(mo,e);.//ne when nw should w XXXX
//2 blocks
...
//+!checkObstacles(ne,n): not obstacle(-1,-1) & obstacle(0,-1) & obstacle(1,-1) & extraAction(false) & (lastAction(no_action) | lastAction(move) | lastAction(skip) | lastAction(submit) | lastAction(attach)) & lastActionResult(success) <- -+currDir(e); -+extraAction(true); -+extraActionValues(mo,s); !chooseAction(mo,e);.
//+!checkObstacles(ne,n): obstacle(-1,-1) & not obstacle(0,-1) & obstacle(1,-1) & extraAction(false) & (lastAction(no_action) | lastAction(move) | lastAction(skip) | lastAction(submit) | lastAction(attach)) & lastActionResult(success) <- -+currDir(e); -+extraAction(true); -+extraActionValues(mo,s); !chooseAction(mo,e);.//ne when nw should w XXXX
//3 blocks
...
/* NW------>N */
//1 block
+!checkObstacles(nw,n): obstacle(-1,-1) & not obstacle(0,-1) & not obstacle(1,-1) & extraAction(false) & (lastAction(no_action) | lastAction(move) | lastAction(skip) | lastAction(submit) | lastAction(attach)) & lastActionResult(success) <- -+currDir(w); -+extraAction(true); -+extraActionValues(mo,s); !chooseAction(mo,w);.
...
+!checkObstacles(nw,n): not obstacle(-1,-1) & not obstacle(0,-1) & obstacle(1,-1) & extraAction(false) & (lastAction(no_action) | lastAction(move) | lastAction(skip) | lastAction(submit) | lastAction(attach)) & lastActionResult(success) <- -+currDir(w); -+extraAction(true); -+extraActionValues(mo,n);  !chooseAction(mo,w);.
//2 blocks
...
//+!checkObstacles(nw,n): obstacle(-1,-1) & not obstacle(0,-1) & obstacle(1,-1) & extraAction(false) & (lastAction(no_action) | lastAction(move) | lastAction(skip) | lastAction(submit) | lastAction(attach)) & lastActionResult(success) <- -+currDir(w); -+extraAction(true); -+extraActionValues(mo,s); !chooseAction(mo,w);.//ne when nw should w XXXX
//3 blocks
...
+!checkObstacles(_,_): extraAction(true) & (lastAction(no_action) | lastAction(move) | lastAction(skip) | lastAction(submit) | lastAction(attach)) & lastActionResult(success) <- ?extraActionValues(ACTION,DIR); /*-+currDir(D);*/ -+extraAction(false);  !chooseAction(ACTION,DIR);.

/* NE------>E */
//1 block
+!checkObstacles(ne,e): obstacle(1,-1) & not obstacle(1,0) & not obstacle(1,1) & extraAction(false) & (lastAction(no_action) | lastAction(move) | lastAction(skip) | lastAction(submit) | lastAction(attach)) & lastActionResult(success) <- -+currDir(e); -+extraAction(true); -+extraActionValues(mo,s); !chooseAction(mo,e);.//ne when se should n XXXX
...
+!checkObstacles(ne,e): not obstacle(1,-1) & not obstacle(1,0) & obstacle(1,1) & extraAction(false) & (lastAction(no_action) | lastAction(move) | lastAction(skip) | lastAction(submit) | lastAction(attach)) & lastActionResult(success) <- -+currDir(n); -+extraAction(true); -+extraActionValues(mo,e); !chooseAction(mo,n);.//ne when se should s XXXX
//2 blocks
...
//+!checkObstacles(ne,e): obstacle(1,-1) & not obstacle(1,0) & obstacle(1,1) & extraAction(false) & (lastAction(no_action) | lastAction(move) | lastAction(skip) | lastAction(submit) | lastAction(attach)) & lastActionResult(success) <- -+currDir(n); -+extraAction(true); -+extraActionValues(mo,w); !chooseAction(mo,n);. //ne when se should s XXXX
//3 blocks
...
/* SE------>E */
//1 block
+!checkObstacles(se,e): obstacle(1,-1) & not obstacle(1,0) & not obstacle(1,1) & extraAction(false) & (lastAction(no_action) | lastAction(move) | lastAction(skip) | lastAction(submit) | lastAction(attach)) & lastActionResult(success) <- -+currDir(s); -+extraAction(true); -+extraActionValues(mo,e); !chooseAction(mo,s);.
+!checkObstacles(se,e): not obstacle(1,-1) & obstacle(1,0) & not obstacle(1,1) & extraAction(false) & (lastAction(no_action) | lastAction(move) | lastAction(skip) | lastAction(submit) | lastAction(attach)) & lastActionResult(success) <- -+currDir(s); -+extraAction(true); -+extraActionValues(mo,w); !chooseAction(mo,s);.
+!checkObstacles(se,e): not obstacle(1,-1) & not obstacle(1,0) & obstacle(1,1) & extraAction(false) & (lastAction(no_action) | lastAction(move) | lastAction(skip) | lastAction(submit) | lastAction(attach)) & lastActionResult(success) <- -+currDir(s); -+extraAction(true); -+extraActionValues(mo,w); !chooseAction(mo,s);.
//2 blocks
...
//+!checkObstacles(se,e): not obstacle(1,-1) & obstacle(1,0) & obstacle(1,1) & extraAction(false) & (lastAction(no_action) | lastAction(move) | lastAction(skip) | lastAction(submit) | lastAction(attach)) & lastActionResult(success) <- -+currDir(s); -+extraAction(true); -+extraActionValues(mo,w); !chooseAction(mo,s);.
//+!checkObstacles(se,e): obstacle(1,-1) & not obstacle(1,0) & obstacle(1,1) & extraAction(false) & (lastAction(no_action) | lastAction(move) | lastAction(skip) | lastAction(submit) | lastAction(attach)) & lastActionResult(success) <- -+currDir(s); -+extraAction(true); -+extraActionValues(mo,w); !chooseAction(mo,s);.
//3 blocks
...
/* SE------>S */
//1 block
+!checkObstacles(se,s): obstacle(-1,1) & not obstacle(0,1) & not obstacle(1,1) & extraAction(false) & (lastAction(no_action) | lastAction(move) | lastAction(skip) | lastAction(submit) | lastAction(attach)) & lastActionResult(success) <- -+currDir(e); -+extraAction(true); -+extraActionValues(mo,s); !chooseAction(mo,e);.//se when sw should w XXXX
...
+!checkObstacles(se,s): not obstacle(-1,1) & not obstacle(0,1) & obstacle(1,1) & extraAction(false) & (lastAction(no_action) | lastAction(move) | lastAction(skip) | lastAction(submit) | lastAction(attach)) & lastActionResult(success) <- -+currDir(e); -+extraAction(true); -+extraActionValues(mo,n); !chooseAction(mo,e);.//se when sw should e XXXX
//2 blocks
...
//+!checkObstacles(se,s): not obstacle(-1,1) & obstacle(0,1) & obstacle(1,1) & extraAction(false) & (lastAction(no_action) | lastAction(move) | lastAction(skip) | lastAction(submit) | lastAction(attach)) & lastActionResult(success) <- -+currDir(e); -+extraAction(true); -+extraActionValues(mo,n); !chooseAction(mo,e);.
//+!checkObstacles(se,s): obstacle(-1,1) & not obstacle(0,1) & obstacle(1,1) & extraAction(false) & (lastAction(no_action) | lastAction(move) | lastAction(skip) | lastAction(submit) | lastAction(attach)) & lastActionResult(success) <- -+currDir(e); -+extraAction(true); -+extraActionValues(mo,n); !chooseAction(mo,e);.
//3 blocks
...
/* SW------>S */
//1 block
+!checkObstacles(sw,s): obstacle(-1,1) & not obstacle(0,1) & not obstacle(1,1) & extraAction(false) & (lastAction(no_action) | lastAction(move) | lastAction(skip) | lastAction(submit) | lastAction(attach)) & lastActionResult(success) <- -+currDir(w); -+extraAction(true); -+extraActionValues(mo,n); !chooseAction(mo,w);.
...
+!checkObstacles(sw,s): not obstacle(-1,1) & not obstacle(0,1) & obstacle(1,1) & extraAction(false) & (lastAction(no_action) | lastAction(move) | lastAction(skip) | lastAction(submit) | lastAction(attach)) & lastActionResult(success) <- -+currDir(w); -+extraAction(true); -+extraActionValues(mo,s); !chooseAction(mo,w);.//se when sw should e XXXX
//2 blocks
...
//+!checkObstacles(sw,s): obstacle(-1,1) & not obstacle(0,1) & obstacle(1,1) & extraAction(false) & (lastAction(no_action) | lastAction(move) | lastAction(skip) | lastAction(submit) | lastAction(attach)) & lastActionResult(success) <- -+currDir(w); -+extraAction(true); -+extraActionValues(mo,n); !chooseAction(mo,w);.//se when sw should w XXXX
//3 blocks
...
/* NW------>W */
//1 block
+!checkObstacles(nw,w): obstacle(-1,-1) & not obstacle(-1,0) & not obstacle(-1,1) & extraAction(false) & (lastAction(no_action) | lastAction(move) | lastAction(skip) | lastAction(submit) | lastAction(attach)) & lastActionResult(success) <- -+currDir(n); -+extraAction(true); -+extraActionValues(mo,e); !chooseAction(mo,n);.//nw when sw should s XXXX
...
+!checkObstacles(nw,w): not obstacle(-1,-1) & not obstacle(-1,0) & obstacle(-1,1) & extraAction(false) & (lastAction(no_action) | lastAction(move) | lastAction(skip) | lastAction(submit) | lastAction(attach)) & lastActionResult(success) <- -+currDir(n); -+extraAction(true); -+extraActionValues(mo,w); !chooseAction(mo,n);.//nw when sw should s XXXX
...
//+!checkObstacles(nw,w): obstacle(-1,-1) & not obstacle(-1,0) & obstacle(-1,1) & extraAction(false) & (lastAction(no_action) | lastAction(move) | lastAction(skip) | lastAction(submit) | lastAction(attach)) & lastActionResult(success) <- -+currDir(n); -+extraAction(true); -+extraActionValues(mo,e); !chooseAction(mo,n);.//nw when sw should s XXXX
//3 blocks
...
/* SW------>W */
//1 block
+!checkObstacles(sw,w): obstacle(-1,-1) & not obstacle(-1,0) & not obstacle(-1,1) & extraAction(false) & (lastAction(no_action) | lastAction(move) | lastAction(skip) | lastAction(submit) | lastAction(attach)) & lastActionResult(success) <- -+currDir(s); -+extraAction(true); -+extraActionValues(mo,w); !chooseAction(mo,s);.
...
+!checkObstacles(sw,w): not obstacle(-1,-1) & not obstacle(-1,0) & obstacle(-1,1) & extraAction(false) & (lastAction(no_action) | lastAction(move) | lastAction(skip) | lastAction(submit) | lastAction(attach)) & lastActionResult(success) <- -+currDir(s); -+extraAction(true); -+extraActionValues(mo,e); !chooseAction(mo,s);.
...
//+!checkObstacles(sw,w): not obstacle(-1,-1) & obstacle(-1,0) & obstacle(-1,1) & extraAction(false) & (lastAction(no_action) | lastAction(move) | lastAction(skip) | lastAction(submit) | lastAction(attach)) & lastActionResult(success) <- -+currDir(s); -+extraAction(true); -+extraActionValues(mo,e); !chooseAction(mo,s);.
//+!checkObstacles(sw,w): obstacle(-1,-1) & not obstacle(-1,0) & obstacle(-1,1) & extraAction(false) & (lastAction(no_action) | lastAction(move) | lastAction(skip) | lastAction(submit) | lastAction(attach)) & lastActionResult(success) <- -+currDir(s); -+extraAction(true); -+extraActionValues(mo,e); !chooseAction(mo,s);.
//3 blocks
...
/* N */
+!checkObstacles(_,n): 	((obstacle(0,-2) & obstacle(-2,0)) | (obstacle(0,-2) & obstacle(-1,-1)) | (obstacle(-1,-1) & obstacle(-2,0)) 
...
+!checkObstacles(_,n): 	((not obstacle(-2,0) & obstacle(-1,-1) & obstacle(0,-2) & obstacle(1,-1) & not obstacle(2,0)) | 
						...
						<- -+currDir(s); -+extraAction(true); -+extraActionValues(cl,n); !chooseAction(mo,s);.
/* S */
+!checkObstacles(_,s): 	((obstacle(-2,0) & obstacle(0,2)) | (obstacle(-2,0) & obstacle(-1,1)) | (obstacle(-1,1) & obstacle(0,2)) 
...
+!checkObstacles(_,s): 	((not obstacle(-2,0) & obstacle(-1,1) & obstacle(0,2) & obstacle(1,1) & not obstacle(2,0)) | 
						(obstacle(-2,0) & obstacle(-1,1) & obstacle(0,2) & obstacle(1,1) & obstacle(2,0))) & extraAction(false)
						<- -+currDir(n); -+extraAction(true); -+extraActionValues(cl,s); !chooseAction(mo,n);.
/* E */
+!checkObstacles(_,e): 	((obstacle(2,0) & obstacle(0,-2)) | (obstacle(2,0) & obstacle(1,-1)) | (obstacle(1,-1) & obstacle(0,-2)) 
						| (obstacle(2,0) & obstacle(1,-1) & obstacle(0,-2))) & extraAction(false) 
...
+!checkObstacles(_,e): 	((not obstacle(0,-2) & obstacle(1,-1) & obstacle(2,0) & obstacle(1,1) & not obstacle(0,2)) | 
						...
						<- -+currDir(w); -+extraAction(true); -+extraActionValues(cl,e); !chooseAction(mo,w);.
/* W */					
+!checkObstacles(_,w): 	((obstacle(-2,0) & obstacle(0,-2)) | (obstacle(-2,0) & obstacle(-1,-1)) | (obstacle(-1,-1) & obstacle(0,-2)) 
						| (obstacle(-2,0) & obstacle(-1,-1) & obstacle(0,-2))) & extraAction(false)
						<- -+currDir(s); !chooseAction(mo,s);.
+!checkObstacles(_,w): 	((obstacle(-2,0) & obstacle(0,2)) | (obstacle(-2,0) & obstacle(-1,1)) | (obstacle(-1,1) & obstacle(0,2)) 
						| (obstacle(-2,0) & obstacle(-1,1) & obstacle(0,2))) & extraAction(false) 
...
+!checkObstacles(_,w): 	((not obstacle(0,-2) & obstacle(-1,-1) & obstacle(-2,0) & obstacle(-1,1) & not obstacle(0,2)) | 
						(obstacle(0,-2) & obstacle(-1,-1) & obstacle(-2,0) & obstacle(-1,1) & obstacle(0,2))) & extraAction(false)	
						<- -+currDir(e); -+extraAction(true); -+extraActionValues(cl,w); !chooseAction(mo,e);.
/* NO OBSTACLE */					
+!checkObstacles(_,D): 	not obstacle(0,-2) & not obstacle(1,-1) & not obstacle(2,0) & 
						not obstacle(1,1) & not obstacle(0,2) & not obstacle(-1,1) & 
						not obstacle(-2,0) & not obstacle(-1,-1) & extraAction(false) 	
						<- -+currDir(D); !chooseAction(mo,D);.
